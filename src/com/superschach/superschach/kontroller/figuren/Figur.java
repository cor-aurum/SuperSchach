...
public abstract class Figur// extends Pr�fer
{
    ...
    /**
     * Diese Methode pr�ft, bis zu welchem Feld im positiven Bereich  auf der X-Achse gerade begehbar sind
     */
    ...
    /**
     * Diese Methode pr�ft, bis zu welchem Feld im positiven Bereich auf der Y-Achse gerade begehbar sind
     */
    ...
    /**
     * Diese Methode pr�ft, bis zu welchem Feld im negativen Bereich  auf der X-Achse gerade begehbar sind
     */
    ...
    /**
     * Diese Methode pr�ft, bis zu welchem Feld im negativen Bereich auf der Y-Achse gerade begehbar sind
     */
    public byte geradeFreiYMinus()
    {
        ...
        {          
            ...
            int inhalt=kontroller.inhaltFaktor(posx, posy);       //     kontroller.inhaltFaktor(posx, posy) wird zwischengespeichert
            if(inhalt!=0)
            {
    ...
    public byte diagonalFreiPositivNegativ()
    {
        ...
        byte randx=(byte)((7-posx)<(posy)?kontroller.XMax:(posx+posy));//7-((7-(posy+posx))   (7-7)+(posy+posx)   posy+posx  -das kann nicht sein...
        byte y=(byte)posy;
        for(byte x=(byte)posx; y<randx; x++)
        {
            int inhalt=kontroller.inhaltFaktor(x,y);
    ...
    public byte diagonalFreiNegativNegativ()
    {
        ...
        //anzahl begehbarer fehlder=posy
        //letztes begehbares xfeld=posx+posy
        byte randx=(byte)((kontroller.XMax-posx)<(posy)?7:(posx+posy));//7-((7-(posy+posx))   (7-7)+(posy+posx)   posy+posx  -das kann nicht sein...
        byte y=(byte)posy;
        for(byte x=(byte)posx; y>randx; x--)
        {
            int inhalt=kontroller.inhaltFaktor(x,y);
    ...
    */
    ...
    public boolean rochadeMoeglich(int x, int y){return false;}
