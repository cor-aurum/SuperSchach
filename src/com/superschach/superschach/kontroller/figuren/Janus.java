...
public class Janus extends Figur
{
	...
	public Janus(Kontroller kontroller, int x, int y, byte faktorplayer,
	...
	{
		return ((kontroller.inhalt(x, y) * vorzeichen() <= 0)
				&& (pruefer.diagonal(gebePosX(), gebePosY(), x, y)) && pruefer
					.frei(gebePosX(), gebePosY(), x, y))
				|| (pruefer.springer(gebePosX(), gebePosY(), x, y))
